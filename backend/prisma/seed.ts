...
async function main() {
    ...
    const meditationSessions = [
        {
            ...
            colorTheme: '#1a1a2e',
            audioUrl: '/uploads/meditations/meditationtidurnyenyak.mp3',
        },
        
        
        {
            title: 'Meditasi Pernafasan',
        ...
        },
        {
            ...
            colorTheme: '#5d2d7a',
            audioUrl: '/uploads/meditations/meditation4.mp3',
        },
        {
            title: 'MBSR Terpandu (Meredakan Overthinking & Stres Akademik)',
            description: 'Sesi relaksasi berbasis kesadaran (MBSR) untuk memutus siklus overthinking dan meredakan stres akademik.',
            category: 'focus' as const,
            durationOptions: ['5', '10'],
            colorTheme: '#355c7d',
            audioUrl: '/uploads/meditations/meditationovt.mp3',
        },
        {
        ...
        {
            title: 'Relaksasi Tubuh Sebelum Tidur',
            description: 'Panduan relaksasi memindai tubuh (body scan) untuk melepaskan ketegangan fisik sebelum beristirahat.',
            category: 'sleep' as const,
            durationOptions: ['10', '15'],
            colorTheme: '#2b213a',
            audioUrl: '/uploads/meditations/meditationtidur.mp3',
        },
        {
            title: 'Penenang Pikiran yang Berlari (Racing Thoughts)',
            description: 'Teknik khusus untuk menenangkan pikiran yang terus berputar akibat lonjakan kecemasan.',
            category: 'anxiety' as const,
            durationOptions: ['5', '10'],
            colorTheme: '#436f62',
            audioUrl: '/uploads/meditations/meditationpenghilangstres.mp3',
        },
    ];
    ...
    console.log('Updating targetSeverity for seeded data...');
