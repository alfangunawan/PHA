...
router.post('/techniques', authenticateToken, requireRole('MINDFULNESS_ADMIN', 'ADMIN'), validate(createTechniqueSchema), BreathingController.create);
router.put('/techniques/:id', authenticateToken, requireRole('MINDFULNESS_ADMIN', 'ADMIN'), BreathingController.update);
router.delete('/techniques/:id', authenticateToken, requireRole('MINDFULNESS_ADMIN', 'ADMIN'), BreathingController.remove);
