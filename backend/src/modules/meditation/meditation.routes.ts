...
router.post('/sessions', authenticateToken, requireRole('MINDFULNESS_ADMIN', 'ADMIN'), validate(createSessionSchema), MeditationController.createSession);
router.put('/sessions/:id', authenticateToken, requireRole('MINDFULNESS_ADMIN', 'ADMIN'), MeditationController.updateSession2);
router.delete('/sessions/:id', authenticateToken, requireRole('MINDFULNESS_ADMIN', 'ADMIN'), MeditationController.deleteSession);
